...
# 
# ## Dataset
# Let's begin by looking at the dataset we have. We have three WAVE files, each of which is a mix, as we've mentioned. 
# 
# 
...
signal_1 = np.frombuffer(signal_1_raw, dtype='int16')
...
signal_3 = np.frombuffer(signal_raw_3, np.int16)
